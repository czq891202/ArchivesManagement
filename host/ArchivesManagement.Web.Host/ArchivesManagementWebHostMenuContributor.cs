...
{
    public class ArchivesManagementWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public ArchivesManagementWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<ArchivesManagementResource>>();
